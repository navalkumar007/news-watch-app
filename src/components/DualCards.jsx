    ...
    return (
        <>
            ...
            <Flex mb="0.5rem" flexDir={{ base: "column", md: "row" }}>
                <Card height={height} imgSrc={LeftCardImgSrc} fallbackSrc={fallbackSrc} alt='' CardTitle='Featured' CardSubtitle={LeftCardTitle} BadgeText={LeftBadgeText} articleLink={LeftCardLink} />
                <Card height={height} imgSrc={RightCardImgSrc} fallbackSrc={fallbackSrc2} alt='' CardTitle='Top' CardSubtitle={RightCardTitle} BadgeText={RightBadgeText} articleLink={RightCardLink} />
            </Flex>
        </>
    )
}

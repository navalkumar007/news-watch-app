...
import { Box, useColorModeValue, Center, Badge, Button, Skeleton, Spinner, useToast, useColorMode } from "@chakra-ui/react";
...
export default function Home() {
  ...
  const fetchData = () => {
    ...
    NewsDataService.getNews().then((response) => {
      //Load the api data
      ...
      .catch((e) => {
        //Log the error
        showToast('Error', 'Something went wrong. Please check if the original website is still running', 'error');
        console.log(e);
      });
  };
    ...
    <>
      <Box minHeight="100vh" bg={useColorModeValue("gray.200", "gray.900")}>
        ...
        <Center h='50px' color={useColorModeValue("black", "white")}
          ...
          fontSize='md'>
          Auto-refreshing in....
          <Badge borderRadius='full' px='2' py='1' bg={useColorModeValue("whiteAlpha.500", "gray.200")} color='red.500' ml="0.25em">
